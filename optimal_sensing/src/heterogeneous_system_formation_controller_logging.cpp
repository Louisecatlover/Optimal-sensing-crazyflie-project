...
optimal_sensing::output_uavs_pose uavs_pose, log_pose;
optimal_sensing::output_uavs_controller formation_controller,uavs_vel, log_vel, log_vel_est;
...
//UAV onboard estimated pose
crazyflie_driver::GenericLogData log_1_pose, log_2_pose, log_3_pose;
void log_pose_cb1(const crazyflie_driver::GenericLogData::ConstPtr& msg){
    log_1_pose = *msg;
}
void log_pose_cb2(const crazyflie_driver::GenericLogData::ConstPtr& msg){
    log_2_pose = *msg;
}
void log_pose_cb3(const crazyflie_driver::GenericLogData::ConstPtr& msg){
    log_3_pose = *msg;
}
//UAV onboard desired velocity
crazyflie_driver::GenericLogData log_1_vel, log_2_vel, log_3_vel;
void log_vel_cb1(const crazyflie_driver::GenericLogData::ConstPtr& msg){
    log_1_vel = *msg;
}
void log_vel_cb2(const crazyflie_driver::GenericLogData::ConstPtr& msg){
    log_2_vel = *msg;
}
void log_vel_cb3(const crazyflie_driver::GenericLogData::ConstPtr& msg){
    log_3_vel = *msg;
}
//UAV onboard estimated velocity
crazyflie_driver::GenericLogData log_1_vel_est, log_2_vel_est, log_3_vel_est;
void log_vel_est_cb1(const crazyflie_driver::GenericLogData::ConstPtr& msg){
    log_1_vel_est = *msg;
}
void log_vel_est_cb2(const crazyflie_driver::GenericLogData::ConstPtr& msg){
    log_2_vel_est = *msg;
}
void log_vel_est_cb3(const crazyflie_driver::GenericLogData::ConstPtr& msg){
    log_3_vel_est = *msg;
}
////////////////////////////////////////////////////////////
...
int main(int argc, char **argv)
{
    ...
    ros::Subscriber log_pose_sub1 = nh.subscribe<crazyflie_driver::GenericLogData>("/crazyflie1/log_pose", 1, log_pose_cb1);
	ros::Subscriber log_pose_sub2 = nh.subscribe<crazyflie_driver::GenericLogData>("/crazyflie2/log_pose", 1, log_pose_cb2);
    ros::Subscriber log_pose_sub3 = nh.subscribe<crazyflie_driver::GenericLogData>("/crazyflie3/log_pose", 1, log_pose_cb3);
    ros::Subscriber log_vel_sub1 = nh.subscribe<crazyflie_driver::GenericLogData>("/crazyflie1/log_vel", 1, log_vel_cb1);
	ros::Subscriber log_vel_sub2 = nh.subscribe<crazyflie_driver::GenericLogData>("/crazyflie2/log_vel", 1, log_vel_cb2);
    ros::Subscriber log_vel_sub3 = nh.subscribe<crazyflie_driver::GenericLogData>("/crazyflie3/log_vel", 1, log_vel_cb3);
    ros::Subscriber log_vel_est_sub1 = nh.subscribe<crazyflie_driver::GenericLogData>("/crazyflie1/log_vel_est", 1, log_vel_est_cb1);
	ros::Subscriber log_vel_est_sub2 = nh.subscribe<crazyflie_driver::GenericLogData>("/crazyflie2/log_vel_est", 1, log_vel_est_cb2);
    ros::Subscriber log_vel_est_sub3 = nh.subscribe<crazyflie_driver::GenericLogData>("/crazyflie3/log_vel_est", 1, log_vel_est_cb3);
    //Publisher
    ...
    ros::Publisher log_pose_pub = nh.advertise<optimal_sensing::output_uavs_pose>("/log_pose", 1);
    ros::Publisher log_vel_pub = nh.advertise<optimal_sensing::output_uavs_controller>("/log_vel", 1);
    ros::Publisher log_vel_est_pub = nh.advertise<optimal_sensing::output_uavs_controller>("/log_vel_est", 1);
    ...
    while(ros::ok()){
       ...
       //pose check
        ...
        ////////////////////Publish UAV logging data//////////////////
        //onboard estimated pose check
        log_pose.rx_c.data = log_1_pose.values[0];
        log_pose.ry_c.data = log_1_pose.values[1];
        log_pose.rz_c.data = log_1_pose.values[2];
        log_pose.theta_c.data = 0;
        log_pose.rx_r.data = log_2_pose.values[0];
        log_pose.ry_r.data = log_2_pose.values[1];
        log_pose.rz_r.data = log_2_pose.values[2];
        log_pose.theta_r.data = 0;
        log_pose.rx_b.data = log_3_pose.values[0];
        log_pose.ry_b.data = log_3_pose.values[1];
        log_pose.rz_b.data = log_3_pose.values[2];
        log_pose.theta_b.data = 0;
        log_pose_pub.publish(log_pose);
        //onboard desired velocity check
        log_vel.vx_1.data = log_1_vel.values[0];
        log_vel.vy_1.data = log_1_vel.values[1];
        log_vel.vz_1.data = log_1_vel.values[2];
        log_vel.wz_1.data = log_1_vel.values[3];
        log_vel.vx_2.data = log_2_vel.values[0];
        log_vel.vy_2.data = log_2_vel.values[1];
        log_vel.vz_2.data =  log_2_vel.values[2];
        log_vel.wz_2.data =  log_2_vel.values[3];
        log_vel.vx_3.data =  log_3_vel.values[0];
        log_vel.vy_3.data =  log_3_vel.values[1];
        log_vel.vz_3.data =  log_3_vel.values[2];
        log_vel.wz_3.data =  log_3_vel.values[3];
        log_vel_pub.publish(log_vel);
        //onboard estimated velocity check
        log_vel_est.vx_1.data = log_1_vel_est.values[0];
        log_vel_est.vy_1.data = log_1_vel_est.values[1];
        log_vel_est.vz_1.data = log_1_vel_est.values[2];
        log_vel_est.wz_1.data = log_1_vel_est.values[3];
        log_vel_est.vx_2.data = log_2_vel_est.values[0];
        log_vel_est.vy_2.data = log_2_vel_est.values[1];
        log_vel_est.vz_2.data =  log_2_vel_est.values[2];
        log_vel_est.wz_2.data =  log_2_vel_est.values[3];
        log_vel_est.vx_3.data =  log_3_vel_est.values[0];
        log_vel_est.vy_3.data =  log_3_vel_est.values[1];
        log_vel_est.vz_3.data =  log_3_vel_est.values[2];
        log_vel_est.wz_3.data =  log_3_vel_est.values[3];
        log_vel_est_pub.publish(log_vel_est);
        ////////////////////////////////////////////////////////////////////
