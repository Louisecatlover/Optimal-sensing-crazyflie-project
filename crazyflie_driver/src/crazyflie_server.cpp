...
void cmdPositionSetpoint(
  ...
  void run()
  {
    ...
    //m_subscribeCmdVel = n.subscribe(m_tf_prefix + "/cmd_vel", 2, &CrazyflieROS::cmdVelChanged, this);
    //m_subscribeCmdFullState = n.subscribe(m_tf_prefix + "/cmd_full_state", 2, &CrazyflieROS::cmdFullStateSetpoint, this);
    ...
    //m_subscribeCmdStop = n.subscribe(m_tf_prefix + "/cmd_stop", 2, &CrazyflieROS::cmdStop, this);
    //m_subscribeCmdPosition = n.subscribe(m_tf_prefix + "/cmd_position", 2, &CrazyflieROS::cmdPositionSetpoint, this);
